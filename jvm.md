...
## Thread's stack and method call basics:
 ...
 - Each Method frame consist of
  ...
  3. Operand stack also store the return values from any other method called from this method. 
