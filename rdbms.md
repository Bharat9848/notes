## Glossary
 - Global transaction
 - Data modeling is important in case you might want to forgo the transaction guarntees. It may require to put otherwise transaction data in same table or document.
